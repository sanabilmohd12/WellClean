        ...
        child: Consumer<MainProvider>(
          builder: (context,proValue,child) {
            return Column(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                space(),
                proValue.ventureResidence.isNotEmpty? toplefttext("Ventures"): Center(child: Padding(
                  padding: const EdgeInsets.all(18.0),
                  child: Text("    No Ventures Added Yet \n    \nAdd Ventures to Show here ",  style:  TextStyle(color: Colors.red,fontSize: 20),),
                )),
                ...
                proValue.ResidenceCTypemodelclasslist.isNotEmpty? toplefttext("Cleaning Types"):Center(child: Padding(
                  padding: const EdgeInsets.all(18.0),
                  child: Text("    No Cleaning Types Added Yet \n    \nAdd Cleaning Types to Show here ",  style:  TextStyle(color: Colors.red,fontSize: 20),),
                )),
                Consumer<MainProvider>(builder: (context, value, child) {
                  return ListView.builder(
                    padding: EdgeInsets.zero,
