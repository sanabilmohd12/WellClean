...
class addManageSerices extends StatelessWidget {
   addManageSerices({super.key,});
          ...
          children: [
            ...
            Center(
              ...
              return GestureDetector(
                ...
                child: value.manageservicesfileimg != null? Container(
                        width: 340,
                        height: 150,
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(12),
                            color: Colors.white24),
                        child: Image.file(value.manageservicesfileimg!))
                    : Container(
                        width: 150,
                        height: 150,
                        decoration: BoxDecoration(
              ...
              builder: (context, value, child) {
                ...
                return Container(
                  ...
                  child: TextFormField(textAlign: TextAlign.center,
                      controller: value.ManageServiceNameController,
                  ...
                  return Container(
                    ...
                    decoration: ShapeDecoration(
                        ...
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(6))),
                    child: TextFormField(textAlign: TextAlign.center,
                        controller: value.AdvanceAmountController,
                ...
                builder: (context, value, child) {
                  return Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (value.ManageServiceNameController.text.isNotEmpty &&
                            value.AdvanceAmountController.text.isNotEmpty &&
                            value.manageservicesfileimg != null) {
                          value.addManageservices();
                          Navigator.pop(context);
                          value.getManageservices();
                        } else {
